package priv.cy.owner.shiro.session;
 ...
 * @author ：cuiyang
 * @description：TODO
 * @date ：Created in 2019/12/30 21:15
 */
public class CustomSessionManager extends DefaultWebSessionManager {
  ...
  protected Serializable getSessionId(ServletRequest request, ServletResponse response) {
    String sessionId =
        WebUtils.toHttp(request).getHeader(AUTHORIZATION); // 如果请求头中有 Authorization 则其值为sessionId
